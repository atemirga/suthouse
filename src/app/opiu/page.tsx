...
= ЧИСТАЯ ПРИБЫЛЬ (Net Income)            · Рентабельность = / Выручка`}
      ...
      <details className="panel p-4 text-sm text-gray-700">
        ...
        <div className="mt-3 space-y-2.5 leading-relaxed">
          <p>
            <b>Индикатор закрытия месяца</b> в шапке колонок:
            🟢 — месяц закрыт в 1С, фактическая себестоимость рассчитана.
            🟡 — закрытие проведено частично (нет «Расчёт фактической себестоимости»).
            ⚪ — месяц открыт, COGS считается по скользящей FIFO и может пересчитаться
            после закрытия в 1С.
          </p>
          <p>
